...
class ChineseFragment : BaseFragment() {


    companion object {
        @SuppressLint("StaticFieldLeak")
        private var mBinding: FragmentChineseBinding? = null
        fun disableThem() {
            if(mBinding != null) {
    ...
    private var chineseAdapter: MenuAdapter? = null
    ...
    override fun onCreateView(
        ...
        val options = FirebaseRecyclerOptions.Builder<MenuModel>()
            .setQuery(
                FirebaseDatabase.getInstance().reference.child("chineseMainCourse").orderByChild("name"),
        ...
        mBinding!!.rvDishList.adapter = chineseAdapter
    ...
    private fun searchDish(s: String) {
        val options1 = FirebaseRecyclerOptions.Builder<MenuModel>()
            .setQuery(
                FirebaseDatabase.getInstance().reference.child("chineseMainCourse")
